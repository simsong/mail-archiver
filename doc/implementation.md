...
fallbacks. Strict sample decodes are ranked using printable text and a modest
CJK signal, then the highest-ranked viable codec strictly decodes the complete
payload. The
