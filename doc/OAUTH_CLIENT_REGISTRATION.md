...
Takeout is the supported end-user path today; see [GMAIL.md](GMAIL.md).
...
![Google Auth Platform Branding page with the Get started button](../website/static/images/gmail-authorization/01-get-started.png)
...
![App Information with the app name and support-email selector](../website/static/images/gmail-authorization/02-app-information.png)
...
![Audience selection with External selected](../website/static/images/gmail-authorization/03-external-audience.png)

4. Under **Contact Information**, enter **your own Google address**, then select
   **Next**.

![Contact Information with the developer email field](../website/static/images/gmail-authorization/04-contact-information.png)

5. Read Google's user-data policy. If you agree, select the checkbox and
   **Continue**.

![Finish step with the Google API Services User Data Policy checkbox](../website/static/images/gmail-authorization/05-user-data-policy.png)

6. When all four sections have blue check marks, select **Create**.

![Completed project configuration ready to create](../website/static/images/gmail-authorization/06-create-configuration.png)

7. Google returns to the OAuth Overview after creating the configuration.

![OAuth Overview confirming that the configuration was created](../website/static/images/gmail-authorization/07-configuration-created.png)
...
![Audience page showing the Add users button](../website/static/images/gmail-authorization/08-add-test-user.png)
...
![Branding page showing app-domain and developer-contact fields](../website/static/images/gmail-authorization/09-branding-requirements.png)
